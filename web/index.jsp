...
<html lang="es">
    ...
    <h1 class="h1" data-text="Moreno">Moreno</h1>
    ...
    <main class="container my-5 main-padding" id="main">
        ...
        <!-- <section class="section" id="about">
            <div class="row centro">
                <div class="col">
                     <img src="images/dibu_foto.PNG" alt="Mi_foto" class="mi-foto">
                 </div>

            </div>
        </section> -->

        <section class="row centro p-3 text-center reveal fadeInLeft">
        ...
        <section class="row centro p-3 text-center reveal fadeInRight">
            <div class="col-12 col-lg-6">
        ...
        <section class="row centro p-3 text-center reveal fadeInLeft mb-5 pb-5">
            <div class="col-12 col-lg-6">
        ...
        <section class="darken border-top border-bottom reveal fadeInRight aire">
            ...
            <div class="row centro text-center change-background" data-color="rgb(20,20,20)">
                <div class="col-12 col-lg-6">
                    <h4 class="mb-3 font-weight-bold p-blog"><span class="brackets align-middle">{</span> BLOG <span class="brackets align-middle">}</span></h4>
